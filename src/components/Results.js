...
const Results = ({ userAnswers, score, scoreMax, restartQuiz }) => {
  ...
  return (
    <div className="results-container">
      ...
      {threeTries}
      {fourTries}
      <div className="results-total">Your Total Score is <strong>{score}</strong> out of <strong>{scoreMax}</strong>.</div>
